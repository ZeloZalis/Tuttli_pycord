...
class Gifs(commands.Cog):
    ...
    @client.slash_command(guild_ids=testing_server, name="urielito", description="Publica un gif de Uriel.")
    ...
    @client.slash_command(guild_ids=testing_server, name="yes", description="Un mensaje para ye.")
    async def Yes(self, ctx):
        await ctx.respond("Ye puto.")
    
    @client.slash_command(guild_ids=testing_server, name="freddy", description="Publica un gif de Freddy.")
    ...
    @client.slash_command(guild_ids=testing_server, name="luí", description="Publica un gif de Luí.")
    async def Luí(self, ctx):
        await ctx.respond("https://c.tenor.com/yvdqdIeLhFMAAAAd/tenor.gif")
    
    @client.slash_command(guild_ids=testing_server, name="payito", description="Publica un gif de Payito.")
    ...
    @client.slash_command(guild_ids=testing_server, name="ehlipin", description="Publica un gif de Ehlipin.")
    ...
    @client.slash_command(guild_ids=testing_server, name="yoelito", description="Publica un gif de Yoelito.")

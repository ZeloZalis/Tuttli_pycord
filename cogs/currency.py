...
class dollarAPI(commands.Cog):
    ...
    #La información de los precios actuales
    @commands.slash_command(guild_ids=testing_server, name="euro", description="Muestra los precios del euro en Venezuela.")
    async def Euro(self, ctx):
        ...
        dolar_embed = discord.Embed(title="Precio del Euro en Venezuela", color=discord.Color.green())
